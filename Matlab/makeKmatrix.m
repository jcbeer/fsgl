%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% MAKEKMATRIX
% Function to create K matrix for fused sparse group 
% lasso penalties. Provides input for fsglfit.m.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
function [K, nj, nd, ngroups, groupsizes] = makeKmatrix(dim1, dim2, dim3, mask, groups) 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
