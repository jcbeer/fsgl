...
% for non-adaptive penalties.
% Uses output from function makeKmatrix.m.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% K: K matrix 
%   (output from makeKmatrix function)
    ...
    for t = 1:Niter
        ...
        for i = 1:N
            currenttheta(groupindices{i}) = softthresh(eta(groupindices{i}),...
                (Lambda(i) * sqrt(numel(eta(groupindices{i})))) / rho);
        end
        % update mu
