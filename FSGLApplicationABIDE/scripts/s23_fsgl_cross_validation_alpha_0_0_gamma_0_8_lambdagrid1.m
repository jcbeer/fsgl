...
delete(gcp('nocreate')) % stop parallel pool


%% save output 
% change filename to match alpha, gamma, lambdagrid used
save('cvresults_alpha_0_0_gamma_0_8_lambdagrid1.mat', 'cvresults')
save('niterations_alpha_0_0_gamma_0_8_lambdagrid1.mat', 'niterations')
